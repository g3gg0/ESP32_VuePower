...
void handle_set_parm()
{
    ...
    current_config.frequency_calib = max(0, min(2, webserver.arg("cal_freq").toFloat()));

    for (int ch = 0; ch < 16; ch++)
    {
        char sym[32];
        sprintf(sym, "cal_ch_%d", ch);
...
#define ADD_CONFIG_COLOR(name, value, fmt, desc)                                                                                       \
    ...
    ADD_CONFIG("cal_ch_2", current_config.sensor_calib_channel[2], "%f", "Calib value channel 3");
    ADD_CONFIG("cal_ch_3", current_config.sensor_calib_channel[3], "%f", "Calib value channel 4");
    ADD_CONFIG("cal_ch_4", current_config.sensor_calib_channel[4], "%f", "Calib value channel 5");
    ADD_CONFIG("cal_ch_5", current_config.sensor_calib_channel[5], "%f", "Calib value channel 6");
    ADD_CONFIG("cal_ch_6", current_config.sensor_calib_channel[6], "%f", "Calib value channel 7");
    ADD_CONFIG("cal_ch_7", current_config.sensor_calib_channel[7], "%f", "Calib value channel 8");
    ADD_CONFIG("cal_ch_8", current_config.sensor_calib_channel[8], "%f", "Calib value channel 9");
    ADD_CONFIG("cal_ch_9", current_config.sensor_calib_channel[9], "%f", "Calib value channel 10");
    ADD_CONFIG("cal_ch_10", current_config.sensor_calib_channel[10], "%f", "Calib value channel 11");
    ADD_CONFIG("cal_ch_11", current_config.sensor_calib_channel[11], "%f", "Calib value channel 12");
    ADD_CONFIG("cal_ch_12", current_config.sensor_calib_channel[12], "%f", "Calib value channel 13");
    ADD_CONFIG("cal_ch_13", current_config.sensor_calib_channel[13], "%f", "Calib value channel 14");
    ADD_CONFIG("cal_ch_14", current_config.sensor_calib_channel[14], "%f", "Calib value channel 15");
    ADD_CONFIG("cal_ch_15", current_config.sensor_calib_channel[15], "%f", "Calib value channel 16");

    ADD_CONFIG("sel_ch_0", current_config.sensor_phase[0], "%d", "Reference phase channel 1");
    ADD_CONFIG("sel_ch_1", current_config.sensor_phase[1], "%d", "Reference phase channel 2");
    ADD_CONFIG("sel_ch_2", current_config.sensor_phase[2], "%d", "Reference phase channel 3");
    ADD_CONFIG("sel_ch_3", current_config.sensor_phase[3], "%d", "Reference phase channel 4");
    ADD_CONFIG("sel_ch_4", current_config.sensor_phase[4], "%d", "Reference phase channel 5");
    ADD_CONFIG("sel_ch_5", current_config.sensor_phase[5], "%d", "Reference phase channel 6");
    ADD_CONFIG("sel_ch_6", current_config.sensor_phase[6], "%d", "Reference phase channel 7");
    ADD_CONFIG("sel_ch_7", current_config.sensor_phase[7], "%d", "Reference phase channel 8");
    ADD_CONFIG("sel_ch_8", current_config.sensor_phase[8], "%d", "Reference phase channel 9");
    ADD_CONFIG("sel_ch_9", current_config.sensor_phase[9], "%d", "Reference phase channel 10");
    ADD_CONFIG("sel_ch_10", current_config.sensor_phase[10], "%d", "Reference phase channel 11");
    ADD_CONFIG("sel_ch_11", current_config.sensor_phase[11], "%d", "Reference phase channel 12");
    ADD_CONFIG("sel_ch_12", current_config.sensor_phase[12], "%d", "Reference phase channel 13");
